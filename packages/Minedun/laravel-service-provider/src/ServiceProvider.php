...
namespace Minedun\ServiceProvider;
...
class ServiceProvider extends IlluminateProvider
{
    ...
    protected function publishConfig(array $files = [])
    {
        ...
        foreach ($files as $file) {
            $paths[$file] = $this->buildDestPath('config', [$this->buildFileName($file)]);
        }
    ...
    {
        $this->publishes([
            $this->paths['views']['src'] => $this->buildDestPath('views', $this->packageName),
        ], 'views');
    ...
    {
        $this->publishes([
            $this->paths['assets']['src'] => $this->buildDestPath('assets', $this->packageName),
        ], 'public');
    ...
    protected function publishSeeds(array $files = [])
    {
        ...
        $paths = [];
        foreach ($files as $file) {
            $paths[$file] = $this->buildDestPath('seeds', [$this->buildFileName($file)]);
        }
