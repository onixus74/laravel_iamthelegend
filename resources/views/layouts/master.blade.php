...
<head>
    ...
    {!! HTML::style('https://cdn.datatables.net/s/bs-3.3.5/jqc-1.11.3,dt-1.10.10,se-1.1.0/datatables.min.css') !!}
...
{!! HTML::script('https://cdn.datatables.net/s/bs-3.3.5/jqc-1.11.3,dt-1.10.10,se-1.1.0/datatables.min.js') !!}
